...
filepath = "../../weights/checkpoints/best_model_512memcell-.3dropouts_{epoch:02d}-{loss:.4f}.hdf5"
...
best_model_filepath = f"../../weights/best_checkpoints_cat/best_model_512memcell-.3dropouts_{best_epoch+1:02d}-{best_loss:.4f}.hdf5"
