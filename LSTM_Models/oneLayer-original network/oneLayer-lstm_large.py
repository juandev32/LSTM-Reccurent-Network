...
#TEXT GENERATION WITH WEIGHTS FILE
import os
...
best_model_filepath = f"../../weights/best_checkpoints_cat/best_model_onelayer_.2dropout_{best_epoch+1:02d}-{best_loss:.4f}-bigger.hdf5"
