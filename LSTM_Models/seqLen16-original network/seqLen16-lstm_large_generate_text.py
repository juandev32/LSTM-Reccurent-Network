...
n_vocab = len(chars) #set so chars wont repeat
...
#store the sequence and next character. sequence patterns is input and out is what will be used to tune weights
...
filename_pattern = "../../weights/best_checkpoints_cat/best_model_seqlen16_*.hdf5"
