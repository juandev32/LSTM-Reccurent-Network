...
# Train the model
history=model.fit(X, y, epochs=75, batch_size=32, callbacks=callbacks_list)
...
best_model_filepath = f"../../weights/best_checkpoints_cat/best_model_seqlen16_{best_epoch+1:02d}-{best_loss:.4f}.hdf5"
