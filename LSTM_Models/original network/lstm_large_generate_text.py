...
filename_pattern = "../../weights/best_checkpoints_cat/best_model_twolayer_.2dropouts_*.hdf5"
...
print(f"\nOutput for {load_weights_file[46:-5]} saved in the generated_text_OUTPUTS directory")