...
filename_pattern = "../weights/best_checkpoints_bee/best_model_BeeMovie-lstm_ThreeLayer_seqLen16_*.hdf5"
...
output_text_file=f"../generated_text_OUTPUTS/OUTPUT - {load_weights_file[43:-5]}.txt"

with open (output_text_file,"w") as file:
	file.write("Seed Sequence:\n\n" + seed_sequence + "\n\nModel Output (1000 characters):\n\n" +output_sequence)
# Text generation complete	
print(f"\nOutput for {load_weights_file[43:-5]} saved in the generated_text_OUTPUTS directory")